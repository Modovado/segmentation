...
# TEST
group.add_argument('--test-image-dir', metavar='NAME', default=r'D:/Vaihingen_Cropped_1024_geoseg/test/image/',#_geoseg
                   help='path to image dataset')
group.add_argument('--test-label-dir', metavar='NAME', default=r'D:/Vaihingen_Cropped_1024_geoseg/test/label/',#_geoseg
...
group.add_argument('--checkpoint', metavar='TEST', default='epoch_98.pth',  #checkpoint
