...
# TRAIN + VAL
group.add_argument('--trainval-image-dir', metavar='NAME', default=r'D:/Vaihingen_Cropped_1024_geoseg/train_val/image/', #_geoseg
                   help='path to image dataset')
group.add_argument('--trainval-label-dir', metavar='NAME', default=r'D:/Vaihingen_Cropped_1024_geoseg/train_val/label/', #_geoseg
                   help='path to label dataset')
...
group.add_argument('--num-classes', type=int, default=5, metavar='N', #geoseg
