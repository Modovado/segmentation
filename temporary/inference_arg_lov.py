...
from dataset.lov_dataset import SatelliteDataset
...
# TEST
group.add_argument('--test-image-dir', metavar='NAME', default=r'D:\LoveDa_Cropped\test\all\image/', #_geoseg
                   help='path to image dataset')
group.add_argument('--test-label-dir', metavar='NAME', default=r'D:\LoveDa_Cropped\test\all\label/',
...
group.add_argument('--num-classes', type=int, default=7, metavar='N', #loveda
...
group.add_argument('--checkpoint', metavar='TEST', default='epoch_56.pth',  #checkpoint
...
def main():
    ...
    # dataset
    # TEST
    # [NOTE] loveda dataset is already a RGB dataset, opt-out the to_rgb option
    ...
    loss_fns = [CELoss(ignore_index=255), DiceLoss(ignore_index=255), FocalLoss(ignore_index=255)]
    ...
    # has aux loss
    test(device, model, testdataloader, loss_fns, metric_fns, pred_path, palette='loveda')
