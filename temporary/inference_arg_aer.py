...
# TEST
group.add_argument('--test-image-dir', metavar='NAME', default=r'D:/AerialImageDataset/test/img_pieces/',
                   help='path to image dataset')
group.add_argument('--test-label-dir', metavar='NAME', default=r'D:/AerialImageDataset/test/label_pieces/',
...
group.add_argument('--checkpoint', metavar='TEST', default='MetricMeter_F1.pth',  # checkpoint
...
def main():
    ...
    # dataset
    # TEST
    testdataset = SatelliteDataset(image_dir=args.test_image_dir,
    ...
    loss_fns = [CELoss(ignore_index=5), DiceLoss(ignore_index=5), FocalLoss(ignore_index=5)]
    ...
    # has aux loss
    test(device, model, testdataloader, loss_fns, metric_fns, pred_path, palette='satellite')
