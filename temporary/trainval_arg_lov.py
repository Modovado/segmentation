...
# [TRAIN + VAL]
group.add_argument('--trainval-image-dir', metavar='NAME', default=r'D:\LoveDa_Cropped\train_val\all\image/',
                   help='path to image dataset')
group.add_argument('--trainval-label-dir', metavar='NAME', default=r'D:\LoveDa_Cropped\train_val\all\label/',
...
def main():
    ...
    # metric_fns = [F1_Score(ignore_index=6), IoU_Score(ignore_index=6)]
